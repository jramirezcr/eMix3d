...
!-----------------------------------------------------------------------
      ...
      allocate(corr_esp_u(16,nz,nz))
      allocate(corr_esp_v(16,nz,nz))
      allocate(corr_esp_w(16,nz,nz))
      allocate(corr_esp_t(16,nz,nz))
...
!-----------------------------------------------------------------------
      ...
      deallocate(wz)
      deallocate(st)
      deallocate(corr_esp_u)
      deallocate(corr_esp_v)
      deallocate(corr_esp_w)
      deallocate(corr_esp_t)
      deallocate(frontx)
      deallocate(frontz)
      deallocate(fronty)
      deallocate(frontin)

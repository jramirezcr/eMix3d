        ...
        DO k=1,nz
         DO j=1,ny
          DO i=1,nx
           ...
           g(i,j,k)=-um(i,j,k,4)*u(i,j,k,3) - pres(i,j,k)! - froude*x(i,j,k,3) 
          END DO
         END DO
        END DO

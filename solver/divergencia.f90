         ...
         DO k=1,nz
          DO j=1,ny
           DO i=1,nx
            ...
            f(i,j,k)=jbn(i,j,k,10)*(jbn(i,j,k,5)*f(i,j,k))
            g(i,j,k)=jbn(i,j,k,10)*(jbn(i,j,k,9)*g(i,j,k))
           END DO
          END DO
         END DO
         ...
         DO k=1,nz
          DO j=1,ny
           DO i=1,nx
            ...
            fv(i,j,k)=jbn(i,j,k,10)*(jbn(i,j,k,5)*fv(i,j,k))
            gv(i,j,k)=jbn(i,j,k,10)*(jbn(i,j,k,9)*gv(i,j,k))
           END DO
          END DO
         END DO

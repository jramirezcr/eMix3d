      ...
      DO k=1,nz
       DO j=1,ny
        DO i=1,nx
         ...
         t4=jbn(i,j,k,3)*jbn(i,j,k,8)-jbn(i,j,k,2)*jbn(i,j,k,9)
         t7=jbn(i,j,k,2)*jbn(i,j,k,6)-jbn(i,j,k,3)*jbn(i,j,k,5)
         t2=jbn(i,j,k,6)*jbn(i,j,k,7)-jbn(i,j,k,4)*jbn(i,j,k,9)
         t5=jbn(i,j,k,1)*jbn(i,j,k,9)-jbn(i,j,k,3)*jbn(i,j,k,7)
         t8=jbn(i,j,k,3)*jbn(i,j,k,4)-jbn(i,j,k,1)*jbn(i,j,k,6)
         t3=jbn(i,j,k,4)*jbn(i,j,k,8)-jbn(i,j,k,5)*jbn(i,j,k,7)
         t6=jbn(i,j,k,2)*jbn(i,j,k,7)-jbn(i,j,k,1)*jbn(i,j,k,8)
